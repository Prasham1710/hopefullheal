...
const page = () => {
  ...
  return (
    ...
    >
      ...
      {/* Section for L */}
      <div className="my-4 mx-40">
        <h2 id="l" className="font-bold pl-20">
          L
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for M */}
      <div className="my-4 mx-40">
        <h2 id="m" className="font-bold pl-20">
          M
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for N */}
      <div className="my-4 mx-40">
        <h2 id="n" className="font-bold pl-20">
          N
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for O */}
      <div className="my-4 mx-40">
        <h2 id="o" className="font-bold pl-20">
          O
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for P */}
      <div className="my-4 mx-40">
        <h2 id="p" className="font-bold pl-20">
          P
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for R */}
      <div className="my-4 mx-40">
        <h2 id="r" className="font-bold pl-20">
          R
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for S */}
      <div className="my-4 mx-40">
        <h2 id="s" className="font-bold pl-20">
          S
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for T */}
      <div className="my-4 mx-40">
        <h2 id="t" className="font-bold pl-20">
          T
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for U */}
      <div className="my-4 mx-40">
        <h2 id="u" className="font-bold pl-20">
          U
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for V */}
      <div className="my-4 mx-40">
        <h2 id="v" className="font-bold pl-20">
          V
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for W */}
      <div className="my-4 mx-40">
        <h2 id="w" className="font-bold pl-20">
          W
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
      ...
      {/* Section for Z */}
      <div className="my-4 mx-40">
        <h2 id="z" className="font-bold pl-20">
          Z
        </h2>
        <ul className="text-blue-600">
          <li className="hover:text-black hover:underline cursor-pointer pb-2">
