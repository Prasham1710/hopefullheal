...
const Page = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-200 to-purple-100">
      <div className="max-w-lg w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="mt-8">
          <h2 className="text-lg font-bold text-purple-800">Appointments</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            {products.map((product) => (
              <div
                key={product.id}
                className="flex flex-col items-center justify-center py-4 px-6 bg-white rounded-lg shadow-sm cursor-pointer hover:bg-gray-100"
